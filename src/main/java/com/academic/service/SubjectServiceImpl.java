...
public class SubjectServiceImpl implements SubjectService {
    ...
    public SubjectResponse create(SubjectRequest request) {
        log.info("Request received to create Subject with code: {}",
    ...
    public Page<SubjectResponse> getAll(
        ...
        log.info("Fetching paginated Subjects - page: {}, size: {}, search: {}, dept: {}, type: {}, status: {}",
        ...
        Page<Subject> pageResult = repository.searchAndFilter(
                cleanSearch, cleanDept, cleanType, cleanStatus, credits, pageable
        );
        return pageResult.map(SubjectMapper::toResponse);
    }

    private void validateRequest(SubjectRequest request) {
        if (request == null) {
