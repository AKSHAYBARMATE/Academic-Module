...
public class CollegeSubjectMapper {

    public static CollegeSubject toEntity(CollegeSubjectRequest request, Degree degree, Department department) {
    ...
    public static void updateEntity(CollegeSubject entity, CollegeSubjectRequest request, Degree degree, Department department) {
    ...
    public static CollegeSubjectResponse toResponse(CollegeSubject entity) {
        ...
        return CollegeSubjectResponse.builder()
                .id(entity.getId())
    ...
    public static List<CollegeSubjectResponse> toResponseList(List<CollegeSubject> list) {
        if (list == null) return new ArrayList<>();
        return list.stream().map(CollegeSubjectMapper::toResponse).collect(Collectors.toList());
    }
}
